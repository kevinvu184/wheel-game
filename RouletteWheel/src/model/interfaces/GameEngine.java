...
/**
 * Assignment interface for Further Programming providing main model
 * functionality for this Roulette style game
 * 
 * @author Caspar Ryan
 * 
 */
public interface GameEngine {
	 ...
	 * {@link BetType#applyWinLoss(Player player, Slot winSlot)})
	 * 
	 * @param winningSlot - the winning slot as passed to
	 *                    GameEngineCallback.result(...)
	 */
	...
	/**
	 * the implementation should make appropriate calls on the Player to place the
	 * bet and set bet type
	 * 
	 ...
	 * @return true - if bet is greater than 0 and player had sufficient points to
	 *         place the bet
	 */
	...
	/**
	 * <pre>
	 *  A debug method to return a FULL representation of the 38 slot gaming wheel
	 ...
	 * i.e. don't "reinvent the wheel" so to speak :)
	 * </pre>
	 * 
